//Colour palette that we are using
var Colors = {
	red:0xf25346,
	white:0xd8d0d1,
	brown:0x59332e,
...
function createLights() {
    ...
    ambientLight = new THREE.AmbientLight(0xcd5437, .5);
...
//define a Sea object :
    Sea = function(){
	var geom = new THREE.CylinderGeometry(1500,1500,800,180,40);
...
var AirPlane = function() {
    ...
    //Create front ski
    var geomSki = new THREE.BoxGeometry(60,8,10,1,1,1);
	var matSki = new THREE.MeshPhongMaterial({color:Colors.red, shading:THREE.FlatShading});
	var frontSki = new THREE.Mesh(geomSki, matSki);
    frontSki.position.set(20, -35, 15);
	frontSki.castShadow = true;
	frontSki.receiveShadow = true;
	this.mesh.add(frontSki);
    
    //Create back ski
	var backSki = new THREE.Mesh(geomSki, matSki);
    backSki.position.set(20, -35, -15);
	backSki.castShadow = true;
	backSki.receiveShadow = true;
	this.mesh.add(backSki);
